...
class Connection():
    ...
    def __init__(self):
        ...
        Connection.__user_bd = config.get('DATABASE', 'USER_BD')
        Connection.__password = config.get('DATABASE', 'PASSWORD') 
        Connection.__tipo_banco = config.get('DATABASE', 'TIPO_BANCO')
    ...
    @staticmethod
    def connect():    
        if Connection.__tipo_banco == SQLSERVER:
